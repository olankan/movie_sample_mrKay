...
//
//     final nowPlayingMoviesModel = nowPlayingMoviesModelFromJson(jsonString);

import 'dart:convert';

NowPlayingMoviesModel nowPlayingMoviesModelFromJson(String str) => NowPlayingMoviesModel.fromJson(json.decode(str));
